...
public class SmartSearchService {
    ...
    private static final List<SearchDocument> DOCUMENTS = List.of(
            ...
            document("Audit Trail", "Review immutable PostgreSQL trigger history with old and new values for donor, lab, inventory, transfusion, storage, deferral, and staff activity.", "/admin/audit", "Administration", ADMIN, "audit trail database history immutable old value new value component donation user device location trigger traceability"),
            ...
            document("System Settings", "Customize interface preferences, language, backup policy, security settings, recovery, and session controls.", "/admin/settings", "Settings", ADMIN, "settings system configuration ui language backup recovery restore restore point security session control theme accent font password"),
